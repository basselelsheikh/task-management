    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Task>(t => { 
            t.ToTable(TaskManagementConsts.DbTablePrefix + "Task", TaskManagementConsts.DbSchema);
            t.ConfigureByConvention();

            t.HasOne<IdentityUser>()
             .WithMany()
        ...
        {
            c.ToTable(TaskManagementConsts.DbTablePrefix + "Comment", TaskManagementConsts.DbSchema);
            c.ConfigureByConvention();
        });

        builder.Entity<Attachment>(a =>
        {
            a.ToTable(TaskManagementConsts.DbTablePrefix + "Attachment", TaskManagementConsts.DbSchema);
