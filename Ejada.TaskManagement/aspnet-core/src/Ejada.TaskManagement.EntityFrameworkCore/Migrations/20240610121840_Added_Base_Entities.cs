        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTask_AbpUsers_AssigneeUserId",
                        column: x => x.AssigneeUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTask_AbpUsers_CreatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppAttachment_AppTask_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppComment_AppTask_TaskId",
                        column: x => x.TaskId,
                        principalTable: "AppTask",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAttachment_TaskId",
                table: "AppAttachment",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_AppComment_TaskId",
                table: "AppComment",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTask_AssigneeUserId",
                table: "AppTask",
                column: "AssigneeUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTask_CreatorUserId",
                table: "AppTask",
